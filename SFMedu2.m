...
%for i=1:12
%    frames.images{i}=strcat('test1/',num2str(i),'.jpeg');
%end

% frames.images{1}='templeSparseRing/templeSR0006.png';
% frames.images{2}='templeSparseRing/templeSR0007.png';
% frames.images{3}='templeSparseRing/templeSR0008.png';
% frames.images{4}='templeSparseRing/templeSR0009.png';
% frames.images{5}='templeSparseRing/templeSR0010.png';
% frames.images{1}='dinoRing/dinoR0010.png';
% frames.images{2}='dinoRing/dinoR0011.png';
% frames.images{3}='dinoRing/dinoR0012.png';
% frames.images{4}='dinoRing/dinoR0013.png';
% frames.images{5}='dinoRing/dinoR0014.png';
% frames.images{1}='templeRing/templeR0026.png';
% frames.images{2}='templeRing/templeR0027.png';
% frames.images{3}='templeRing/templeR0028.png';
% frames.images{4}='templeRing/templeR0029.png';
% frames.images{5}='templeRing/templeR0030.png';
...
if max(frames.imsize)>maxSize
    ...
    frames.px = frames.px * scale;
    frames.px = frames.py * scale;
    frames.imsize = size(imresize(imread(frames.images{1}),scale));
end

frames.K = f2K(frames.focal_length);
frames.K=[frames.focal_length,frames.skew,frames.px;0.000000,frames.focal_length,frames.py;0.000000,0.000000,1.000000];
%frames.K=[3310.400000,0.000000,316.730000; 0.000000, 3325.500000, 200.550000; 0.000000, 0.000000, 1.000000];
disp('intrinsics:');
disp(frames.K);
...
for frame=2:frames.length-1
    ...
    res_=[res_,printReprojectionError(mergedGraph)];
end
...
res=printReprojectionError(mergedGraph); % [for homework]
